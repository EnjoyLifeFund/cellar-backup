...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/ruby/2.4.1_1")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/Cellar/ruby/2.4.1_1' '--enable-shared' '--disable-silent-rules' '--with-sitedir=/usr/local/lib/ruby/site_ruby' '--with-vendordir=/usr/local/lib/ruby/vendor_ruby' '--disable-install-doc' '--without-gmp' '--with-opt-dir=/usr/local/opt/libyaml:/usr/local/opt/openssl:/usr/local/opt/readline' 'CC=clang' 'CXX=clang++'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/Cellar/ruby/2.4.1_1"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple LLVM version 8.0.0 (clang-800.0.42.1)\nTarget: x86_64-apple-darwin16.4.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
