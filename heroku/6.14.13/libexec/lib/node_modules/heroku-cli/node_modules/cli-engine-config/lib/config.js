...
function validatePJSON(pjson) {
  ...
  (0, _jestValidate.validate)(cli, { comment, title, exampleConfig: exampleCLI });['s3', 'hooks'].map(attr => {
    (0, _jestValidate.validate)(cli[attr], { comment, title, exampleConfig: exampleCLI[attr] });
  });
}
...
function buildConfig(existing = {}) {
  ...
  return {
    ...
    get hooks() {
      return this.pjson['cli-engine'].hooks || {};
    },
    get windows() {
