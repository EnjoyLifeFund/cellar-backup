...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mariadb/10.2.7_1"
#define SHAREDIR "/usr/local/Cellar/mariadb/10.2.7_1/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mariadb/10.2.7_1"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mariadb/10.2.7_1"
#define PLUGINDIR "/usr/local/Cellar/mariadb/10.2.7_1/lib/plugin"
...
#define PACKAGE_STRING "MySQL Server 10.2.7"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "10.2.7"
#define VERSION "10.2.7"
