...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mariadb/10.2.8"
#define SHAREDIR "/usr/local/Cellar/mariadb/10.2.8/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mariadb/10.2.8"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mariadb/10.2.8"
#define PLUGINDIR "/usr/local/Cellar/mariadb/10.2.8/lib/plugin"
...
#define PACKAGE_STRING "MySQL Server 10.2.8"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "10.2.8"
