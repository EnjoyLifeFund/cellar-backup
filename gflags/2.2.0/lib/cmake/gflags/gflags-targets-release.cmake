...
set_target_properties(gflags_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgflags.2.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgflags.2.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gflags_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gflags_shared "${_IMPORT_PREFIX}/lib/libgflags.2.2.0.dylib" )
...
set_target_properties(gflags_nothreads_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgflags_nothreads.2.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgflags_nothreads.2.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gflags_nothreads_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gflags_nothreads_shared "${_IMPORT_PREFIX}/lib/libgflags_nothreads.2.2.0.dylib" )
