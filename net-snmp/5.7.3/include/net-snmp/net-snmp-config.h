...
#define NETSNMP_CONFIGURE_OPTIONS " '--disable-debugging' '--prefix=/usr/local/Cellar/net-snmp/5.7.3' '--enable-ipv6' '--with-defaults' '--with-persistent-directory=/usr/local/var/db/net-snmp' '--with-logfile=/usr/local/var/log/snmpd.log' '--with-mib-modules=host ucd-snmp/diskio' '--without-rpm' '--without-kmem-usage' '--disable-embedded-perl' '--without-perl-modules' '--with-openssl=/usr/local/opt/openssl' 'CC=clang'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/usr/local/Cellar/net-snmp/5.7.3/share/snmp/mibs"
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:HOST-RESOURCES-TYPES:UCD-DISKIO-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-PASS-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/usr/local/var/db/net-snmp"
...
#define SNMPLIBPATH "/usr/local/Cellar/net-snmp/5.7.3/lib/snmp"
#define SNMPSHAREPATH "/usr/local/Cellar/net-snmp/5.7.3/share/snmp"
#define SNMPCONFPATH "/usr/local/Cellar/net-snmp/5.7.3/etc/snmp"
#define SNMPDLMODPATH "/usr/local/Cellar/net-snmp/5.7.3/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/usr/local/var/log/snmpd.log"
